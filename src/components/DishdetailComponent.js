...
import {LocalForm, Control, Error, Errors} from 'react-redux-form';
                    ...
                    <ModalBody>
                        <LocalForm onSubmit={(values) => this.handleSubmit(values)}>
                            <Row className="form-group">
                                <Label hrmlFor="rating" md={12}>Rating</Label>
                                <Col md={12}>
                            ...
                            <Row className="form-group">
                                <Label hrmlFor="author" md={12}>Your Name</Label>
                                <Col md={12}>
                            ...
                            <Row className="form-group">
                                <Label hrmlFor="comment" md={12}>Comment</Label>
                                <Col md={12}>
                                    <Control.textarea model=".comment" type="textarea" id="comment" name="comment" rows="12" className="form-control"/>
                                </Col>
                            </Row>
                            <Row className="form-group">
                                <Col md={2}>
